...
const getValue = (state: RootState) => {
...
class ClassCounterWO extends Component<RootProps, ClassCounterState> {
  state = {
    numInput: 0,
  ...
  render() {
    ...
    return (
      <div>
        <h2>Class-based Component w/o select</h2>
        <p>count: {count}</p>
...
export default connector(ClassCounterWO);
